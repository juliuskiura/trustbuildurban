...
(function() {
  ...
  const logo = navbar.querySelector('.krestwood-logo');
  const tagline = navbar.querySelector('.krestwood-tagline');
  const links = navbar.querySelectorAll('.krestwood-link');
  const icon = navbar.querySelector('.krestwood-icon');
